    ...
    <div class="row d-flex justify-content-center">
        <div class="col-8">
            <form action="./question1.php" method="post">
                <div class="mb-3">
                    <h1> O que Dom Pedro I gritou no dia da indenpedência?</h1>
                </div>
                <div class="mb-3">
                    <input type="radio" name="question1" id="question1" value="resp1">
                    <label for="question1">indenpedência ou  Morte</label>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <label for="question1">Avise eles que eu ficarei</label>
                </div>
                <div class="mb-3">
                    <input type="radio" name="question1" id="question1" value="resp4">
                    <label for="question1">Não falou nada</label>
                </div>
            ...
            if(isset($_POST['question1'])) {
                ...
                if(!empty($_POST['question1'])) {
                    if($_POST['question1'] == 'resp4') {
                        ...
                        Você acertou <a href="question2.php">Avançar</a>
                        </div>';
